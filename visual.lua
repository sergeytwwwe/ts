-- visual_core.lua
-- НЕ создаёт окно и вкладку! Получает VisualTab как аргумент.
-- Вся логика и UI для вкладки Visual.
...
return function(VisualTab)
    ...
    -- ESP, Chams, Bullet Trail, HitSound, Log, и прочее
